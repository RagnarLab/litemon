...
```bash
# Install litemon
sudo dpkg -i $(curl -w "%{filename_effective}" -SsLO "https://github.com/RagnarLab/litemon/releases/download/v0.2.4/litemon-0.2.4-1.$(uname -m).deb")
...
```bash
# Install litemon
sudo rpm -iv "https://github.com/RagnarLab/litemon/releases/download/v0.2.4/litemon-0.2.4-1.$(uname -m).rpm"
